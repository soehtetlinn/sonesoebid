    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex justify-center items-center">
      <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-xl w-full max-w-md relative">
        ...
        <p className="text-center text-gray-600 dark:text-gray-300 mb-4">
            Use <code className="bg-gray-200 dark:bg-gray-700 p-1 rounded">john@example.com</code> or <code className="bg-gray-200 dark:bg-gray-700 p-1 rounded">admin@example.com</code>.
        </p>
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            <label htmlFor="email" className="block text-gray-700 dark:text-gray-300 font-semibold mb-2">Email Address</label>
            <input
              type="email"
              id="email"
              value={email}
